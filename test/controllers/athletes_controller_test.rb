...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { cidade: @athlete.cidade, dob: @athlete.dob, email: @athlete.email, estado: @athlete.estado, name: @athlete.name } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { cidade: @athlete.cidade, dob: @athlete.dob, email: @athlete.email, estado: @athlete.estado, name: @athlete.name } }
